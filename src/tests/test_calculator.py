...
Étudiant : Vincent de Grandpré (DEGV03078209), E26
"""
...
# Test de quelques addition simples
def test_addition():    
    assert Calculator().addition(2, 3) == 5
    assert Calculator().addition(255, -3234) == -2979

# Test de quelques soustraction simples
...
# Test de quelques multiplicaitions simples
...
# Test de quelques divisions simples
def test_division():
    # assert throw division par 0 - omis volontairement
